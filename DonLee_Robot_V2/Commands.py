...
async def start(bot: DonLee_Robot_V2, msg: Import.Msg):
    ...
    button = [[
     Import.Button('➕ Add Me To Your Groups ➕', url='http://t.me/lokiautofilterbot?startgroup=true')
    ]]
...
async def about(bot: DonLee_Robot_V2, msg: Import.Msg):
        button = [[
          Import.Button("🎬 Group", url='https://t.me/NetflixMovies_sslinkz'),
...
async def admin(bot, msg):
    button = [[  
       Import.Button("𝖢𝗅𝗂𝖼𝗄 𝖧𝖾𝗋𝖾➡️", url="t.me/sarathi_admin")
       ]]
    await msg.reply_text(
